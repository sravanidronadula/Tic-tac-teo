...
({
   ...
   openModel: function(component, event, helper) {
     ...
     var name5= component.find("inputname5").get("v.value");
       ...
       var count11= component.find("input11").get("v.value");
 ...
 var custs = [];
   ...
   submitDetails: function(component, event, helper) {
    ...
    saveRecord : function(component, event, helper) {
        var action = component.get("c.saveDataToServer");
        action.setParams({ P1: component.get("v.count"),
        P2: component.get("v.count1"),
        P3: component.get("v.count2"),
                          P4: component.get("v.count3"),
                          P5: component.get("v.count4"),
                          P6: component.get("v.count5"),
                          P7: component.get("v.count6"),
                          P8: component.get("v.count7"),
                          P9: component.get("v.count8"),
                          P10: component.get("v.count9"),
                          P11: component.get("v.count10"),
                          P12: component.get("v.count11"),
                          P13: component.get("v.count12"),
                          P14: component.get("v.count13"),
                          P15: component.get("v.count14"),
                          P16: component.get("v.count15"),
                          P17: component.get("v.count16"),
                          P18: component.get("v.count17"),
                          P19: component.get("v.count18"),
                          P20: component.get("v.count19"),
                          P21: component.get("v.count20"),
                          P22: component.get("v.count21"),
                         });
        action.setCallback(this, function(response) {
            var state = response.getState();
            if (state === "SUCCESS") {
             alert('Record Created Successfully!!');   // handle the success case
            } else {
               var errors = action.getError();
                if (errors) {
                    if (errors[0] && errors[0].message) {
                        alert(errors[0].message); // handle the error case
            }
                }
            }
        });
